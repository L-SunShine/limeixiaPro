(function (f) {
  ...
  return function e(t, n, r) {
    ...
    1: [function (require, module, exports) {
      ...
      (function () {
        ...
        var Swiper = function (container, params) {
          ...
          s.updateSlidesSize = function () {
            ...
            s.slidesGrid = [];
            s.slidesSizesGrid = [];
            var spaceBetween = s.params.spaceBetween, slidePosition = -s.params.slidesOffsetBefore, i,
            ...
            if (s.rtl) s.slides.css({marginLeft: "", marginTop: ""}); else s.slides.css({
              marginRight: "",
              marginBottom: ""
            });
          ...
          var isTouched, isMoved, allowTouchCallbacks, touchStartTime, isScrolling, currentTranslate, startTranslate,
            allowThresholdMove, formElements = "input, select, textarea, button, video", lastClickTime = Date.now(),
            clickTimeout, velocities = [], allowMomentumBounce;
          s.animating = false;
              ...
              setTranslate: function () {
                ...
                if (s.params.cube.shadow) {
                  if (s.isHorizontal()) {
                    ...
                    var scale1 = s.params.cube.shadowScale, scale2 = s.params.cube.shadowScale / multiplier,
      ...
      exports.default = {
        name: "swiper-slide", data: function data() {
